...
<div class="auth-wrapper auth-cover">
  <div class="auth-inner row m-0">
    ...
    {{-- <a class="brand-logo" href="/">
      ...
      <h2 class="brand-text text-primary ms-1">FORMULIR LAMARAN KERJA</h2>
    </a> --}}
    <!-- /Brand logo-->
  ...
  {{-- /Select Language --}}
    ...
    <!-- Register-->
    <div class="col-lg-12 auth-bg px-3 px-sm-3 px-lg-5 pt-3">
      
      <div class="">
        <h2 class="text-primary">FORMULIR LAMARAN KERJA</h2>
        <div class="bs-stepper register-multi-steps-wizard shadow-none">
          @include('content.lamaran.recruitment_step.steper')
          <div class="bs-stepper-content px-0 mt-4">
            ...
            {{-- Account Step --}}
            @include('content.lamaran.recruitment_step.step1')
            {{-- /Account Step --}}

            {{-- identification-mark Step --}}
            @include('content.lamaran.recruitment_step.step2')
            {{-- /identification-mark Step --}}

            {{-- identification-mark Step --}}
            @include('content.lamaran.recruitment_step.step3')
            {{-- /identification-mark Step --}}

            {{-- educational-background Step --}}
            @include('content.lamaran.recruitment_step.step4')
            {{-- /educational-background Step --}}

            {{-- educational-background Step --}}
            @include('content.lamaran.recruitment_step.step5')
            {{-- /educational-background Step --}}

            {{-- educational-background Step --}}
            @include('content.lamaran.recruitment_step.step6')
            {{-- /educational-background Step --}}
      ...
      var template = [
        '<div class="col-md-3">',
          ...
          '<div class="input-group">',
            ...
            '<span class="input-group-text text-danger" onclick="$(this).parent().parent().remove()" style="cursor: pointer" id="basic-addon2">',
              'X',
            '</span>',
          '</div>',
        ...
        error : function(err){
          ...
          Object.keys(errs).forEach( function(key, value){
            ...
            if(1 in result){
              ...
              $('[name='+key+']').parent().append('<div class="text-danger errs err-'+key+'"> <small> '+errs[key][0].replace(key.replaceAll('_', ' '), '')+' </small> </div>');
            }
