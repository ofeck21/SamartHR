          ...
          <div style="" class="card-datatable table-responsive pt-0">
            <table id="table" class="table table-sm">
              ...
              <tbody id="marital-status">
                ...
                <tr>
                  <td>Suami / Istri</td>
                  <td colspan="2"><input type="text" name="suami_istri" class="form-control"></td>
                  
                  <td><input type="number" name="suami_istri_age" class="form-control"></td>
                  <td>
                    <select name="suami_istri_education" class="form-control select2">
                      @foreach ($option as $item)
                        @if ($item->group == 'school_level')
                          <option value="{{$item->id}}">{{$item->name}}</option>
                        @endif
                  ...
                  <td><input type="text" name="suami_istri_position" class="form-control"></td>
                  <td><input type="text" name="suami_istri_company" class="form-control"></td>
                </tr>
