...
<div class="modal fade text-start" id="importModal" tabindex="-1" aria-labelledby="importModal" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <form id="formImport">
          <div class="modal-body">
            <input type="hidden" name="salary_component_id" id="salary_component_id" value="{{$item->id}}">
            <input type="hidden" name="salary_component_name" id="salary_component_name" value="{{$item->name}}">
            <input type="file" name="file" id="file" class="form-control">
            <hr>
            <i>Download template <strong><a href="/salary-components/download/template-employee-salary-component" target="_blank">here</a></strong></i>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-secondary waves-effect waves-float waves-light" data-bs-dismiss="modal"><i data-feather="x"></i> Close</button>
            <button type="submit" class="btn btn-outline-primary waves-effect waves-float waves-light data-submit"><i data-feather="save"></i> Save</button>
...
@endsection
  ...
  <script src="{{ asset(mix('js/scripts/apps/salary_component_detail.js')) }}"></script>
@endsection