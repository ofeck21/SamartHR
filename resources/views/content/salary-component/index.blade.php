...
<section id="basic-datatable">
      ...
      <div class="modal-content">
        ...
        <form id="formNewRecord">
          <div class="modal-body">
            ...
            <div class="row mb-1">
              <div class="col">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="component_code" maxlength="5" placeholder="Salary Code" name="salary_code">
            ...
            <div class="row mb-1">
              <div class="col">
                <label class="form-label">Given <span class="text-danger">*</span></label>
                <select name="type" id="given" class="form-select select2">
  ...
  <div class="modal fade text-start" id="importModal" tabindex="-1" aria-labelledby="importModal" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="importModalLabel">Import Employee Salary Component</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form id="formImport">
          <div class="modal-body">
            ...
            <hr>
            <i>Download template <strong><a href="/salary-components/download/template-all" target="_blank">here</a></strong></i>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-secondary waves-effect waves-float waves-light" data-bs-dismiss="modal"><i data-feather="x"></i> Close</button>
            <button type="submit" class="btn btn-outline-primary waves-effect waves-float waves-light data-submit"><i data-feather="save"></i> Save</button>
...
@endsection
  ...
  <script src="{{ asset(mix('js/scripts/apps/salary_component.js')) }}"></script>
@endsection
