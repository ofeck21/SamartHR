...
@section('title', lang("Menu Job Level"))
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="addNewRecordLabel">Add New Job Level</h4>
              ...
              <div class="col">
                  ...
                  <select name="position" id="position" class="form-select select2">
                    ...
                    @foreach ($positions as $position)
                      <option value="{{$position->id}}" data-company={{$position->company_id}}>{{$position->name}}
                      @role('Super Admin')
...
@section('vendor-script')
  ...
  <script src="{{ asset(mix('js/scripts/apps/job_level.js')) }}"></script>
@endsection
