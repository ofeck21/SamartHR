...
@section('title', __('menu.Department'))
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="addNewRecordLabel">Add New Department</h4>
...
@section('vendor-script')
  ...
  <script src="{{ asset(mix('js/scripts/apps/deparment.js')) }}"></script>
@endsection
