...
@section('title', __('menu.Job Position'))
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="addNewRecordLabel">Add New Job Position</h4>
              ...
              <div class="col">
                  ...
                  <select name="department" id="department" class="form-select select2">
                    ...
                    @foreach ($departments as $department)
                      <option value="{{$department->id}}" data-company={{$department->company_id}}>{{$department->name}}
                      @role('Super Admin')
...
@section('vendor-script')
  ...
  <script src="{{ asset(mix('js/scripts/apps/job_position.js')) }}"></script>
@endsection
