...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'company'   => [Rule::requiredIf($request->role != 1)]
        ]);
        ...
        try {
            $user = User::create([
                ...
                'company_id'=> $request->role != 1 ? $request->company : null,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $user->company_id = ($request->role == 1) ? null : $request->company;
    ...
    public function profile()
    {
        ...
        $user = User::where('id', Auth::id())->with(['company', 'roles'])->first();
